...
class ResumesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resume" do
    assert_difference('Resume.count') do
      post resumes_url, params: { resume: { attachment: @resume.attachment, category: @resume.category, price: @resume.price, title: @resume.title, year: @resume.year } }
    end
  ...
  test "should update resume" do
    patch resume_url(@resume), params: { resume: { attachment: @resume.attachment, category: @resume.category, price: @resume.price, title: @resume.title, year: @resume.year } }
